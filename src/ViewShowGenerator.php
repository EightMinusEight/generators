...
class ViewShowGenerator {
	...
	protected function populateStub($name, $stub, $schema) {
		...
		$stub = str_replace('DummyShowFields', $formFieldsString, $stub);
	...
	protected function getField($name, $type) {
		...
		// get the stub
		$fieldStub = $this->files->get(__DIR__ . '/stubs/views/partials/show.field.stub');
